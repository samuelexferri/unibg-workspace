...
public class OrdinamentoLineare {
	...
	/**
	 * Ordina l'array di input utilizzando l'algoritmo di integer sort
	 * (<font color=red>Tempo O(n+k)</font>). Assume che gli elementi dell'array
	 * abbiano tutti valore nell'intervallo [0, k - 1], dove k &egrave; indicato da
	 * input.
	 * 
	 * @param A l'array da ordinare
	 * @param k il valore massimo assumibile dagli elementi di <code>A</code>
	 * @throws ArrayOutOfBoundsException se <code>A</code> contiene elementi il cui
	 *                                   valore non &egrave; incluso nell'intervallo
	 *                                   [0, k - 1]
	 * 
	 * 
	 */
