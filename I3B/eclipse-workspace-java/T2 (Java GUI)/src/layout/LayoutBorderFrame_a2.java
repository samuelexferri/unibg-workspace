...
public class LayoutBorderFrame_a2 extends JFrame {
	public LayoutBorderFrame_a2()  {
		...
		//Si vedrà il colore dello sfondo tra i bottoni
		...
		//Dato il valore di vgap maggiore di 0 vedrò lo sfondo tra i bottoni 
		...
		//Aggiungo i JPanel al container sfruttando i punti cardinali offerti dal layout 
