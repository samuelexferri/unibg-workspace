...
// implemento ActionListener perchè voglio usare un bottone per cambiare da una card all'altra
public class LayoutCardFrame extends JFrame implements ActionListener {
	...
	public LayoutCardFrame() {
		...
		//Uno per i bottoni e uno che ospiterà il panel colorato
		...
		for (int i=0;i<3;i++)   {
			...
			//aggiungo il panel appena colorato al panel che lo deve ospitare dandogli un nome (il numero in formato stringa)
			//ATTENZIONE: Non imposto direttamente il colore del panelColor perchè voglio mostrare
			//la funzionalità del metodo show del CardLayout.
			panelColor.add(p,""+i);
	...
	public void actionPerformed(ActionEvent e) {
		...
		//Visualizzo il panel corrispondente tra quelli associati a panelColor richiamandolo con la stringa
