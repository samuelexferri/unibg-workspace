...
class OrderedListModel extends AbstractListModel {
	...
	// Bisogna implementare i seguenti metodi (ereditati dall'interfaccia ma non implementati dalla classe astratta che 
	//stiamo estendendo
...
class FontDefaultListCellRenderer extends DefaultListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,	int index, boolean isSelected, boolean cellHasFocus) {
		...
		//se è selezionato imposta BOLD, altrmenti PLAIN
