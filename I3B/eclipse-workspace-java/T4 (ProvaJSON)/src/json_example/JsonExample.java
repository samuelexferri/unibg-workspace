...
/**
 * Classe che legge da JSON la Astronomy Picture of the Day della NASA Poi
 * modifica il JSON aggiungendo degli attributi, e salvandolo.
 * 
 * ATTENZIONE: attualmente ci sono dei limiti sull'uso di questo servizio, se
 * non dovesse restituire un Json, impostare una API Key
 * 
...
public class JsonExample {
	public static void main(String[] args) {
		try {
			...
			/*
			 * 3. Inserimento nel JSON, a scopo dimostrativo, di un nuovo JSONArray
			 * contentente: - data di oggi - un array con il nome dell'utente e il suo
			 * gradimento, per 3 utenti diversi (gradimento è casuale da 1 a 10)
			 */
